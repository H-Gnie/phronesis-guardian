...
if not st.session_state.messages:
    # Zero-Base 컨셉 적용: 직무 타이틀을 버리고 스킬만 묻도록 유도
    initial_prompt = "현재 하고 있는 일에 만족하십니까? 아니라면, 당신의 직무 이름(타이틀)은 버리고, 그 안에서 당신이 남들보다 빠르고 쉽게 처리하던 '기술'이나 '감각'이 무엇인지 단도직입적으로 묻고 대화를 시작해."
